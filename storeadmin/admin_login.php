...
if (isset($_POST["username"]) && isset($_POST["password"])) {
    ...
    if ($existCount == 1) { // evaluate the count
     ...
     $admin = mysqli_query($con,"SELECT admin FROM admin WHERE username='$user' AND password='$password' LIMIT 1");
     ...
     if ($name == 1) {
       ...
       echo 'Tài khoản của bạn không có quyền truy cập! Thử lại <a href="index.php">tại đây</a>';
   		exit();
     }

    } else {
		echo 'Thông tin tài khoản hoặc mật khẩu không đúng! Thử lại <a href="index.php">tại đây</a>';
		exit();
	}
}
?>
